'''
Your task for this problem is to add a brightness property to this class. Your
code should work as shown in the following test code.
'''
...
class SmartLamp:
    ...
    def brightness(self, brightness):
        ...
        if not 0 <= brightness <= 100:
            raise ValueError('Brightness must be set between 0 and 100.')
